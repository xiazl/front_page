...
const localeInfo = {
  'en-US': {
    messages: require('/Users/baidu/workspace/finance_smart_fe/src/locales/en-US.js').default,
    locale: 'en-US',
    antd: require('antd/lib/locale-provider/en_US'),
    data: require('react-intl/locale-data/en'),
  },
  'zh-CN': {
    messages: require('/Users/baidu/workspace/finance_smart_fe/src/locales/zh-CN.js').default,
    locale: 'zh-CN',
